...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('test_applications', function (Blueprint $table) {
            ...
            $table->foreignId('patient_id')->nullable()->constrained('patients')->onDelete('set null'); // Permite que o patient_id seja nulo e define o comportamento de exclusão
            ...
            $table->string('status')->nullable(); // Status da aplicação do teste (e.g., Pendente, Concluído)
